...
class AnimacionWave extends StatefulWidget {
  @override
  _AnimacionWaveState createState() => _AnimacionWaveState();

  AnimacionWave({Key? key}) : super(key: key) {
    timeDilation = 1.0;
  }
}
...
class _AnimacionWaveState extends State<AnimacionWave> {
  ...
  Widget build(BuildContext context) {
    Size size = Size(MediaQuery.of(context).size.width, 300.0);
    return Scaffold(
      backgroundColor: Colors.transparent,
      body: Stack(
        children: <Widget>[
          ColorCurveBody(
              size: size, xOffset: 20, yOffset: 0, color: Colors.green),
        ],
      ),
    );
  }
